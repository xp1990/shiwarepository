 ...
 * @author zsolt
 */
@WebServlet(name="GetAppAttrServlet", urlPatterns={"/mce/getappattr"})
public class GetAppAttrServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if(appIDs == null){
                response.sendError(400, "missing parameter: 'appids'");
