 ...
 * @author zsolt
 */
public class AppCommentTO {

    public static final String queryPrefix = "SELECT NEW uk.ac.wmin.edgi.repository.transferobjects.CommentTO(o.id, o.application.id, o.created, o.user.loginName) FROM AppComment o ";
    public static final String countPrefix = "SELECT COUNT(o) FROM AppComment o ";
