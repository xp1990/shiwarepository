...
public class GT2 extends BeInstance{
    @Size(max = 100)
    @Column(name = "site")
    private String site;
    @Size(max = 50)
    ...
    public GT2(String _jobManager, JobType _jobTypeId, String _name, Backend _idBackend, String _site, String _backendOut, String _backendErr, OperatingSystems _idOS, User _wedev) {
    ...
    public GT2(String _jobManager, JobType _jobTypeId, String _name, Backend _idBackend, String _site, String _backendOut, String _backendErr, OperatingSystems _idOS, String _resource, User _wedev) {
